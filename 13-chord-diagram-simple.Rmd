...
```{r chord_diagram_basic_gap_after, eval = FALSE, echo = -1}
circos.clear()
...
```{r chord-diagram-color, echo = FALSE, fig.width = 8, fig.height = 8*2/3, fig.cap = "Control colors for Chord diagram."}
chunks <- knitr:::knit_code$get()
par(mfrow = c(2, 3))
...
```{r chord-diagram-border, echo = FALSE, fig.width = 8, fig.height = 8, fig.cap = "Control borders for Chord Diagram."}
chunks <- knitr:::knit_code$get()
par(mfrow = c(2, 2))
...
```{r chord-diagram-link-order2, echo = c(2:4, 6), fig.width = 8, fig.height = 4, fig.cap = "Order of adding links."}
par(mfrow = c(1, 2))
chordDiagram(mat, grid.col = grid.col, transparency = 0)
text(-0.9, 0.9, "A", cex = 1.5)
...
```{r chord-diagram-directional, echo = FALSE, fig.width = 8, fig.height = 8, fig.cap = "Visualization of directional matrix."}
par(mfrow = c(3, 3))
