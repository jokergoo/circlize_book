...
```{r chord-diagram-labels, echo = FALSE, fig.width = 8, fig.height = 8, fig.cap = "Customize sector labels in Chord diagram."}
chunks <- knitr:::knit_code$get()
par(mfrow = c(2, 2))
eval(parse(text = chunks[["chord_diagram_labels_show"]]))
text(-0.9, 0.9, "A", cex = 1.5)
eval(parse(text = chunks[["chord_diagram_labels_inside"]]))
text(-0.9, 0.9, "B", cex = 1.5)
eval(parse(text = chunks[["chord_diagram_labels_multile_style"]]))
circos.clear()
...
```{r chord-diagram-axes, echo = FALSE, fig.cap = "Customize sector axes for Chord diagram."}
chunks <- knitr:::knit_code$get()
...
assists to see the symmetry (Figure \@ref(fig:chord-diagram-symmetric) left).
...
symmetric (Figure \@ref(fig:chord-diagram-symmetric) right).
...
```{r chord-diagram-symmetric, echo = FALSE, fig.width = 8, fig.height = 4, fig.cap = "Rotate Chord diagram."}
par(mfrow = c(1, 2))
chunks <- knitr:::knit_code$get()
