...
```{r nested, echo = FALSE, fig.width = 8, fig.height = 8/3, fig.cap = "Nested zooming between two circular plots."}
chunks <- knitr:::knit_code$get()
par(mfrow = c(1, 3))
eval(parse(text = chunks[["nested_1"]]))
eval(parse(text = chunks[["nested_2"]]))
eval(parse(text = chunks[["nested_3"]]))
```
