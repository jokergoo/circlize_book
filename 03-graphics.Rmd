...
```{r circlize-text-easy, echo = FALSE, fig.width = 6, fig.height = 9, fig.cap = "Human easy text facing."}
...
`rou2` arguments. See Figure \@ref(fig:link-ends).
...
```{r, echo = FALSE, fig.width = 4, fig.height = 4, fig.cap = "Positions of link ends."}
circos.par(points.overflow.warning = FALSE)
circos.initialize(factors = factors, xlim = c(0, 10))
circos.track(factors = factors, ylim = c(0, 1), bg.col = "grey", bg.border = NA, track.height = 0.05)
...
```{r circlize-highlight-sector, fig.width = 4, fig.height = 4}
factors = letters[1:8]
circos.initialize(factors, xlim = c(0, 1))
for(i in 1:4) {
    circos.track(ylim = c(0, 1))
