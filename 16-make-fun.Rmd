...
```{r dartboard, fig.cap = "A dartboard."}
...
```{r bagua, fig.cap = "Ba-Gua and Tai-Ji."}
factors = 1:8
...
```{r doodle, echo = FALSE, fig.cap = "Keith Haring doodle in circular layout."}
