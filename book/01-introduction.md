...
is split by `df$sectors` and the width of sectors are automatically calculated
...
high-level function which means it creates a new track (as you can imagin `hist()`
