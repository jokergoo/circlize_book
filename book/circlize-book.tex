...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cell_cycle =}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{phase =} \KeywordTok{factor}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{"M"}\NormalTok{, }\StringTok{"G1"}\NormalTok{, }\StringTok{"S"}\NormalTok{, }\StringTok{"G2"}\NormalTok{), }\DataTypeTok{levels =} \KeywordTok{c}\NormalTok{(}\StringTok{"M"}\NormalTok{, }\StringTok{"G1"}\NormalTok{, }\StringTok{"S"}\NormalTok{, }\StringTok{"G2"}\NormalTok{)),}
                        \DataTypeTok{hour =} \KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{11}\NormalTok{, }\DecValTok{8}\NormalTok{, }\DecValTok{4}\NormalTok{))}
...
\begin{verbatim}
##    chr  start    end     value1     value2
## 1 chr1  46684 311068  0.0305334 0.05978604
## 2 chr1 481187 749752 -0.2489634 0.01537647
\end{verbatim}
...
## 2 481187 749752
##       value1     value2
## 1  0.0305334 0.05978604
## 2 -0.2489634 0.01537647
\end{verbatim}
